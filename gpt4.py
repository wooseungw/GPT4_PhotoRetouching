...
class Gpt4:
    ...
    def parse(self, filepath, sentence):
        ...
        밝기: -1~1 사이의 값을 가집니다. 양수면 밝아지고, 음수면 어두워집니다.
        대비: 0~2 사이의 값을 가집니다. 1보다 크면 대비가 강해지고, 1보다 작으면 대비가 약해집니다.
        필터: 0~1 사이의 값을 가집니다. 값이 클수록 노이즈 감소 효과가 강해집니다. 
        색상: 0~2 사이의 값을 가집니다. 값이 클수록 색조가 바뀝니다.
        채도: 0~2 사이의 값을 가집니다. 값이 클수록 색상이 선명해집니다.
        명도: 0~2 사이의 값을 가집니다. 값이 클수록 밝기가 증가합니다.
        선명도: . 0~2 사이의 값을 가집니다. 값이 클수록 선명해집니다.
        ...
        PROMPT_RESULT1= {
            ...
            "content": [
                {"type": "text", "text": "\
                 ...
                 [retouch]밝기: 0.1, 대비: 0.9, 필터: 0.2, 색상: 0.2, 채도: 0.8, 명도: 0.3, 선명도: 0.7, 블러: 0.1[/retouch]\
                 "},
            ],
        }
        PROMPT_MESSAGES ={
